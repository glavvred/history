 ...
 */
final class Version20250413125655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE excursion_route ADD region_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE excursion_route ADD CONSTRAINT FK_D0001F3798260155 FOREIGN KEY (region_id) REFERENCES region (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_D0001F3798260155 ON excursion_route (region_id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE excursion_route DROP FOREIGN KEY FK_D0001F3798260155
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_D0001F3798260155 ON excursion_route
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE excursion_route DROP region_id
        SQL);
        $this->addSql(<<<'SQL'
