...
final class Version20240816144857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE public_event (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, duration INT DEFAULT NULL, address VARCHAR(255) NOT NULL, vk VARCHAR(255) DEFAULT NULL, tg VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, short_description VARCHAR(255) NOT NULL, main_photo VARCHAR(255) NOT NULL, additional_photos JSON DEFAULT NULL, prequisites LONGTEXT DEFAULT NULL, toll VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, url VARCHAR(255) DEFAULT NULL, url_text VARCHAR(255) DEFAULT NULL, owner_id INT NOT NULL, category_id INT NOT NULL, region_id INT NOT NULL, organisation_id INT DEFAULT NULL, views INT DEFAULT NULL, INDEX IDX_CA01B5A77E3C61F9 (owner_id), INDEX IDX_CA01B5A712469DE2 (category_id), INDEX IDX_CA01B5A798260155 (region_id), INDEX IDX_CA01B5A79E6B1585 (organisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
